...
export default function Features() {
  const features = [
    {
      title: "AI-Powered Tone Shift",
      icon: "🎭",
      description: "Rewrite your text in different tones like professional, casual, funny, or academic — instantly.",
      gradient: "from-purple-500 to-indigo-600"
    },
    {
      title: "Custom Intensity Control",
      icon: "🎚️",
      description: "Adjust how strong the tone shift should be, from light touch-ups to bold rewrites.",
      gradient: "from-pink-500 to-rose-500"
    },
    {
      title: "One-Click Surprise Me",
      icon: "🎲",
      description: "Not sure what fits best? Let the AI pick a random tone and intensity for you.",
      gradient: "from-amber-400 to-orange-500"
    },
    {
      title: "Platform-Ready Text",
      icon: "📱",
      description: "Generate text that feels natural on LinkedIn, Twitter, Instagram, or wherever you post.",
      gradient: "from-cyan-400 to-blue-500"
    },
    {
      title: "Fast & Simple",
      icon: "⚡",
      description: "Clean interface, no sign-up required. Just paste, tweak, and copy your perfect text.",
      gradient: "from-emerald-400 to-teal-600"
    },
    {
      title: "Creative Control",
      icon: "🎨",
      description: "Adjust intensity and style to make the output interesting.",
  ...
  return (
    <div className="min-h-screen bg-[#000000] bg-[radial-gradient(#ffffff33_1px,#00091d_1px)] bg-[size:20px_20px]">
      ...
      <div className="pt-32 pb-20 px-6 max-w-6xl mx-auto">
        <h1 className="text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-blue-400 to-indigo-500 text-center mb-10">
          Features
        </h1>
